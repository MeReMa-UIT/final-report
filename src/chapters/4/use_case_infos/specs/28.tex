...
\begin{enumerate}
  ...
  \item Admin nhấn nút ``Staffs'', hệ thống chuyển sang giao diện quản lí nhân viên.
  \item Admin nhấn nút ``Register Staff'', hệ thống chuyển sang giao diện thêm nhân viên.
  \item Admin nhập thông tin nhân viên mới vào các trường thông tin.
  \item Admin nhấn nút ``Register'', hệ thống kiểm tra thông tin nhân viên mới và ghi nhận.
\end{enumerate}

\paragraph{\textbf{Các dòng sự kiện khác}}
\begin{enumerate}
  \item Nếu Admin nhấn nút ``Cancel'', hệ thống sẽ quay về giao diện quản lí nhân viên.
