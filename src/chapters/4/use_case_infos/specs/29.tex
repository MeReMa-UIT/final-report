\subsection{Đặc tả Use Case ``Cập nhật thông tin nhân viên''}
...
\begin{enumerate}
  ...
  \item Admin nhấn nút ``Edit Info'', hệ thống chuyển sang giao diện cập nhật thông tin nhân viên.
  \item Admin nhập thông tin cần cập nhật vào các trường tương ứng.
  \item Admin nhấn nút ``Update'', hệ thống kiểm tra thông tin và ghi nhận.
\end{enumerate}

\paragraph{\textbf{Các dòng sự kiện khác:}}
\begin{enumerate}
  \item Nếu admin nhập thông tin không hợp lệ, hệ thống thông báo lỗi và yêu cầu nhập lại.
  \item Nếu admin nhấn nút ``Cancel'', hệ thống quay lại giao diện xem thông tin nhân viên.
\end{enumerate}
