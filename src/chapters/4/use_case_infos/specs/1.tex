...
\begin{enumerate}
  ...
  \item Người dùng nhập thông tin bắt buộc vào các trường ``Email'' và ``Password'' rồi nhấn nút ``Login''.
...
\begin{itemize}
  \item Thông tin đăng nhập phải là kí tự Unicode.
  ...
  \item Yêu cầu đăng nhập:
    \begin{itemize}
      \item Điền đúng kí tự Unicode cho các trường.
