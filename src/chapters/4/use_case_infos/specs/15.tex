...
\begin{enumerate}
  ...
  \item Nhân viên tiếp nhận nhấn nút ``Patients'', hệ thống hiển thị danh sách bệnh nhân.
...
\begin{enumerate}
  \item Nếu nhân viên tiếp nhận nhập thông tin bệnh nhân thiếu hoặc không hợp lệ, hệ thống thông báo lỗi và yêu cầu nhập lại.
  \item Nếu nhân viên tiếp nhận nhấn nút ``Cancel'', hệ thống trở về giao diện danh sách bệnh nhân.
\end{enumerate}
