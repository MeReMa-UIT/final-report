...
\begin{enumerate}
  \item Nếu người dùng là bác sĩ:
    \begin{itemize}
      ...
      \item Bác sĩ nhấn nút ``Patients'', hệ thống chuyển đến giao diện xem thông tin bệnh nhân, trong đó có danh sách bệnh án.
    \end{itemize}
  \item Nếu người dùng là bệnh nhân:
    \begin{itemize}
      \item Bệnh nhân đang ở giao diện chính.
      \item Bệnh nhân nhấn nút Medical Records, hệ thống chuyển đến giao diện xem danh sách bệnh án.
      \item Bệnh nhân chọn tên bệnh nhân cần xem danh sách bệnh án, hệ thống hiển thị danh sách bệnh án của bệnh nhân đó.
    \end{itemize}
\end{enumerate}
