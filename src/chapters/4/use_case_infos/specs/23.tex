...
\begin{enumerate}
  ...
  \item Bệnh nhân nhấn nút ``Schedules'', hệ thống chuyển sang giao diện quản lí lịch hẹn.
  \item Bệnh nhân nhấn nút ``Book Schedule'', hệ thống chuyển sang giao diện lập lịch hẹn.
...
\begin{enumerate}
  \item Nếu bệnh nhân nhấn nút ``Cancel'', hệ thống quay về giao diện quản lí lịch hẹn.
...
\begin{itemize}
  \item Thông tin nhập vào là ngày tháng năm trong tương lai gần và loại lịch hẹn.
